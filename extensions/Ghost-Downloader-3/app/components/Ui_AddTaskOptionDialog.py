...
class Ui_AddTaskOptionDialog(object):
    def setupUi(self, AddTaskOptionDialog):
        ...
        # 任务ID输入区域 - 标签+输入框+服务器地区在一行
        self.xbhLabel = SubtitleLabel(self.scrollWidget)
        self.xbhLabel.setObjectName("xbhLabel")
        self.verticalLayout.addWidget(self.xbhLabel)
        
        self.xbhLayout = QHBoxLayout()
        self.xbhLayout.setObjectName("xbhLayout")
        self.xbhLayout.setSpacing(10)
        
        # 任务ID标签（不加粗）
        from qfluentwidgets import BodyLabel
        self.xbhIdLabel = BodyLabel(self.scrollWidget)
        self.xbhIdLabel.setObjectName("xbhIdLabel")
        self.xbhIdLabel.setText("任务ID:")
        self.xbhLayout.addWidget(self.xbhIdLabel)
        
        # 任务ID输入框
        self.xbhIdEdit = LineEdit(self.scrollWidget)
        self.xbhIdEdit.setObjectName("xbhIdEdit")
        self.xbhIdEdit.setPlaceholderText("支持多个ID，用英文或中文逗号分隔，如: pgz_xxx,pcs_yyy")
        self.xbhIdEdit.setMinimumWidth(200)
        self.xbhLayout.addWidget(self.xbhIdEdit)
        
        # 分隔符
        self.xbhLayout.addSpacing(20)
        
        # 服务器地区标签（不加粗）
        self.serverLabel = BodyLabel(self.scrollWidget)
        self.serverLabel.setObjectName("serverLabel")
        self.serverLabel.setText("服务器:")
        self.xbhLayout.addWidget(self.serverLabel)
        
        # 服务器地区按钮组
        self.serverGroup = QButtonGroup(self.scrollWidget)
        self.serverGroup.setObjectName("serverGroup")
        
        self.radioGuangzhou = QRadioButton(self.scrollWidget)
        self.radioGuangzhou.setObjectName("radioGuangzhou")
        self.radioGuangzhou.setText("广州")
        self.radioGuangzhou.setStyleSheet("QRadioButton { font-weight: normal; padding: 4px 8px; } QRadioButton:checked { background-color: #e3f2fd; border-radius: 4px; }")
        self.serverGroup.addButton(self.radioGuangzhou)
        self.xbhLayout.addWidget(self.radioGuangzhou)
        
        self.radioChangsha = QRadioButton(self.scrollWidget)
        self.radioChangsha.setObjectName("radioChangsha")
        self.radioChangsha.setText("长沙")
        self.radioChangsha.setStyleSheet("QRadioButton { font-weight: normal; padding: 4px 8px; } QRadioButton:checked { background-color: #e3f2fd; border-radius: 4px; }")
        self.serverGroup.addButton(self.radioChangsha)
        self.xbhLayout.addWidget(self.radioChangsha)
        
        self.verticalLayout.addLayout(self.xbhLayout)
    ...
    def retranslateUi(self):
        ...
        # XBH区域文本
        self.xbhLabel.setText(self.tr("批量任务下载(可选)"))
        self.xbhIdEdit.setPlaceholderText(self.tr("支持多个ID，用逗号或空格分隔，如: pgz_xxx pcs_yyy"))
        # 服务器地区文本
        self.serverLabel.setText(self.tr("服务器:"))
